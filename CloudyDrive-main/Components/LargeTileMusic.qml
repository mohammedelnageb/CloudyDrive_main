...
import "../controls"  // Assuming PrefsButton and VehicleSkeletonTile are here
    ...
    ColumnLayout {
        ...
        RowLayout {
            Text {
                ...
                font.family: "Lato"
                color: "#808080"  // replaced Style.alphaColor("#FFFFFF",0.5)
            }
            ...
            RowLayout {
                ...
                PrefsButton {
                    ...
                    onClicked: {
                        if (fractionalPart > 0.0) {
                            fractionalPart = Math.max(0, fractionalPart - 0.1);
                        } else {
                            if (number > 0) {
                                fractionalPart = 0.9;
                                number -= 1;
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                            text: (number + fractionalPart).toFixed(1)
                            font.pixelSize: 38
                            font.weight: Font.Bold
                            font.family: "Lato"
                            color: "#FFFFFF"
                ...
                PrefsButton {
                    ...
                    onClicked: {
                        if (fractionalPart < 0.9) {
                            fractionalPart = Math.min(0.9, fractionalPart + 0.1);
                        } else {
                            fractionalPart = 0.0;
                            number += 1;
                        }
